...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="h-full text-white p-20 flex flex-col justify-end z-0"
                ...
                aria-hidden="true">
            <div className="container mx-auto p-8 mt-96">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-64">
                    <div>
